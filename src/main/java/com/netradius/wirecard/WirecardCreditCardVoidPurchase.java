 ...
 */
public class WirecardCreditCardVoidPurchase extends WirecardCreditCardPayment<WirecardCreditCardVoidPurchase> {

	protected String parentTransactionId;

	protected WirecardCreditCardVoidPurchase(WirecardClient client) {
		super(client);
	}
	...
	public TransactionType getTransactionType() {
		return TransactionType.VOID_PURCHASE;
	}
}
